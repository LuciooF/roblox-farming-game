...
CropRegistry.crops = {
    ...
    wheat = {
        ...
        seedCost = 25, basePrice = 25, growthTime = 45, waterNeeded = 1, harvestCooldown = 25, maxHarvestCycles = 2,
        productionRate = 48, -- crops per hour (32 * 1.5 = 48)
    ...
    carrot = {
        ...
        seedCost = 30, basePrice = 30, growthTime = 60, waterNeeded = 2, harvestCooldown = 30, maxHarvestCycles = 2,
        productionRate = 50, -- crops per hour (30 * 1.5 = 45)
    ...
    basil = {
        ...
        seedCost = 35, basePrice = 35, growthTime = 40, waterNeeded = 2, harvestCooldown = 20, maxHarvestCycles = 3,
        productionRate = 116, -- crops per hour (19 * 1.75 = 33.25 → 34)
    ...
    potato = {
        ...
        seedCost = 60, basePrice = 60, growthTime = 90, waterNeeded = 2, harvestCooldown = 35, maxHarvestCycles = 2,
        productionRate = 63, -- crops per hour (24 * 1.75 = 42)
    ...
    onion = {
        ...
        seedCost = 50, basePrice = 50, growthTime = 60, waterNeeded = 1, harvestCooldown = 25, maxHarvestCycles = 3,
        productionRate = 93, -- crops per hour (23 * 1.75 = 40.25 → 41)
    ...
    lettuce = {
        ...
        seedCost = 45, basePrice = 45, growthTime = 45, waterNeeded = 2, harvestCooldown = 20, maxHarvestCycles = 4,
        productionRate = 66, -- crops per hour (25 * 1.75 = 43.75 → 44)
    ...
    tomato = {
        ...
        seedCost = 80, basePrice = 80, growthTime = 75, waterNeeded = 2, harvestCooldown = 30, maxHarvestCycles = 2,
        productionRate = 116, -- crops per hour (29 * 1.75 = 50.75 → 51)
    ...
    strawberry = {
        ...
        seedCost = 70, basePrice = 70, growthTime = 60, waterNeeded = 3, harvestCooldown = 25, maxHarvestCycles = 3,
        productionRate = 84, -- crops per hour (32 * 1.75 = 56)
        waterCooldown = 25, maintenanceWaterInterval = 12600, -- 25s between waters, 3.5h maintenance
    ...
    corn = {
        ...
        seedCost = 150, basePrice = 150, growthTime = 120, waterNeeded = 3, harvestCooldown = 40, maxHarvestCycles = 2,
        productionRate = 93, -- crops per hour (35 * 1.75 = 61.25 → 62)
    ...
    broccoli = {
        ...
        seedCost = 120, basePrice = 120, growthTime = 80, waterNeeded = 4, harvestCooldown = 30, maxHarvestCycles = 3,
        productionRate = 101, -- crops per hour (38 * 1.75 = 66.5 → 67)
    ...
    eggplant = {
        ...
        seedCost = 250, basePrice = 250, growthTime = 180, waterNeeded = 4, harvestCooldown = 60, maxHarvestCycles = 2,
        productionRate = 104, -- crops per hour (39 * 1.75 = 68.25 → 69)
    ...
    bell_pepper = {
        ...
        seedCost = 100, basePrice = 100, growthTime = 100, waterNeeded = 3, harvestCooldown = 30, maxHarvestCycles = 3,
        productionRate = 98, -- crops per hour (37 * 1.75 = 64.75 → 65)
    ...
    apple = {
        ...
        seedCost = 110, basePrice = 110, growthTime = 150, waterNeeded = 3, harvestCooldown = 40, maxHarvestCycles = 2,
        productionRate = 101, -- crops per hour (38 * 1.75 = 66.5 → 67)
    ...
    avocado = {
        ...
        seedCost = 200, basePrice = 200, growthTime = 180, waterNeeded = 5, harvestCooldown = 50, maxHarvestCycles = 2,
        productionRate = 116, -- crops per hour (44 * 1.75 = 77)
    ...
    mango = {
        ...
        seedCost = 180, basePrice = 180, growthTime = 160, waterNeeded = 4, harvestCooldown = 45, maxHarvestCycles = 2,
        productionRate = 114, -- crops per hour (43 * 1.75 = 75.25 → 76)
    ...
    acorn = {
        ...
        seedCost = 30, basePrice = 30, growthTime = 50, waterNeeded = 2, harvestCooldown = 20, maxHarvestCycles = 3,
        productionRate = 48, -- crops per hour (18 * 1.75 = 31.5 → 32)
    ...
    banana = {
        ...
        seedCost = 45, basePrice = 45, growthTime = 70, waterNeeded = 3, harvestCooldown = 25, maxHarvestCycles = 3,
        productionRate = 53, -- crops per hour (20 * 1.75 = 35)
    ...
    beet = {
        ...
        seedCost = 35, basePrice = 35, growthTime = 55, waterNeeded = 2, harvestCooldown = 18, maxHarvestCycles = 3,
        productionRate = 53, -- crops per hour (20 * 1.75 = 35)
    ...
    blueberry = {
        ...
        seedCost = 65, basePrice = 65, growthTime = 80, waterNeeded = 3, harvestCooldown = 22, maxHarvestCycles = 4,
        productionRate = 87, -- crops per hour (33 * 1.75 = 57.75 → 58)
    ...
    cabbage = {
        ...
        seedCost = 40, basePrice = 40, growthTime = 65, waterNeeded = 3, harvestCooldown = 20, maxHarvestCycles = 2,
        productionRate = 93, -- crops per hour (23 * 1.75 = 40.25 → 41)
    ...
    cherry = {
        ...
        seedCost = 150, basePrice = 150, growthTime = 140, waterNeeded = 4, harvestCooldown = 35, maxHarvestCycles = 3,
        productionRate = 111, -- crops per hour (42 * 1.75 = 73.5 → 74)
    ...
    chilli_pepper = {
        ...
        seedCost = 90, basePrice = 90, growthTime = 110, waterNeeded = 3, harvestCooldown = 28, maxHarvestCycles = 4,
        productionRate = 98, -- crops per hour (37 * 1.75 = 64.75 → 65)
    ...
    coconut = {
        ...
        seedCost = 220, basePrice = 220, growthTime = 200, waterNeeded = 5, harvestCooldown = 60, maxHarvestCycles = 1,
        productionRate = 119, -- crops per hour (45 * 1.75 = 78.75 → 79)
    ...
    dragonfruit = {
        ...
        seedCost = 500, basePrice = 500, growthTime = 250, waterNeeded = 6, harvestCooldown = 80, maxHarvestCycles = 1,
        productionRate = 146, -- crops per hour (55 * 1.75 = 96.25 → 97)
    ...
    cucumber = {
        ...
        seedCost = 45, basePrice = 45, growthTime = 50, waterNeeded = 3, harvestCooldown = 18, maxHarvestCycles = 4,
        productionRate = 72, -- crops per hour (27 * 1.75 = 47.25 → 48)
    ...
    garlic = {
        ...
        seedCost = 25, basePrice = 25, growthTime = 45, waterNeeded = 1, harvestCooldown = 16, maxHarvestCycles = 4,
        productionRate = 116, -- crops per hour (19 * 1.75 = 33.25 → 34)
    ...
    ginger = {
        ...
        seedCost = 70, basePrice = 70, growthTime = 85, waterNeeded = 3, harvestCooldown = 26, maxHarvestCycles = 3,
        productionRate = 93, -- crops per hour (35 * 1.75 = 61.25 → 62)
    ...
    grapes = {
        ...
        seedCost = 160, basePrice = 160, growthTime = 150, waterNeeded = 4, harvestCooldown = 42, maxHarvestCycles = 3,
        productionRate = 111, -- crops per hour (42 * 1.75 = 73.5 → 74)
    ...
    kiwi = {
        ...
        seedCost = 95, basePrice = 95, growthTime = 105, waterNeeded = 3, harvestCooldown = 32, maxHarvestCycles = 3,
        productionRate = 101, -- crops per hour (38 * 1.75 = 66.5 → 67)
    ...
    leek = {
        ...
        seedCost = 30, basePrice = 30, growthTime = 50, waterNeeded = 2, harvestCooldown = 18, maxHarvestCycles = 3,
        productionRate = 116, -- crops per hour (19 * 1.75 = 33.25 → 34)
    ...
    lime = {
        ...
        seedCost = 55, basePrice = 55, growthTime = 60, waterNeeded = 3, harvestCooldown = 22, maxHarvestCycles = 4,
        productionRate = 72, -- crops per hour (27 * 1.75 = 47.25 → 48)
    ...
    lemon = {
        ...
        seedCost = 50, basePrice = 50, growthTime = 55, waterNeeded = 3, harvestCooldown = 20, maxHarvestCycles = 4,
        productionRate = 72, -- crops per hour (27 * 1.75 = 47.25 → 48)
    ...
    mushroom = {
        ...
        seedCost = 85, basePrice = 85, growthTime = 95, waterNeeded = 4, harvestCooldown = 28, maxHarvestCycles = 3,
        productionRate = 93, -- crops per hour (35 * 1.75 = 61.25 → 62)
    ...
    olive = {
        ...
        seedCost = 170, basePrice = 170, growthTime = 170, waterNeeded = 4, harvestCooldown = 48, maxHarvestCycles = 2,
        productionRate = 114, -- crops per hour (43 * 1.75 = 75.25 → 76)
    ...
    orange = {
        ...
        seedCost = 60, basePrice = 60, growthTime = 75, waterNeeded = 3, harvestCooldown = 24, maxHarvestCycles = 4,
        productionRate = 84, -- crops per hour (32 * 1.75 = 56)
    ...
    pea_pod = {
        ...
        seedCost = 22, basePrice = 22, growthTime = 35, waterNeeded = 2, harvestCooldown = 14, maxHarvestCycles = 5,
        productionRate = 48, -- crops per hour (18 * 1.75 = 31.5 → 32)
    ...
    peach = {
        ...
        seedCost = 140, basePrice = 140, growthTime = 130, waterNeeded = 4, harvestCooldown = 38, maxHarvestCycles = 3,
        productionRate = 111, -- crops per hour (42 * 1.75 = 73.5 → 74)
    ...
    pear = {
        ...
        seedCost = 55, basePrice = 55, growthTime = 70, waterNeeded = 3, harvestCooldown = 22, maxHarvestCycles = 3,
        productionRate = 84, -- crops per hour (32 * 1.75 = 56)
    ...
    pumpkin = {
        ...
        seedCost = 75, basePrice = 75, growthTime = 100, waterNeeded = 4, harvestCooldown = 35, maxHarvestCycles = 1,
        productionRate = 87, -- crops per hour (33 * 1.75 = 57.75 → 58)
    ...
    radish = {
        ...
        seedCost = 18, basePrice = 18, growthTime = 30, waterNeeded = 2, harvestCooldown = 12, maxHarvestCycles = 4,
        productionRate = 45, -- crops per hour (17 * 1.75 = 29.75 → 30)
    ...
    raspberry = {
        ...
        seedCost = 85, basePrice = 85, growthTime = 90, waterNeeded = 3, harvestCooldown = 28, maxHarvestCycles = 5,
        productionRate = 98, -- crops per hour (37 * 1.75 = 64.75 → 65)
    ...
    sweet_potato = {
        ...
        seedCost = 42, basePrice = 42, growthTime = 65, waterNeeded = 2, harvestCooldown = 22, maxHarvestCycles = 3,
        productionRate = 66, -- crops per hour (25 * 1.75 = 43.75 → 44)
    ...
    turnip = {
        ...
        seedCost = 28, basePrice = 28, growthTime = 40, waterNeeded = 2, harvestCooldown = 16, maxHarvestCycles = 3,
        productionRate = 48, -- crops per hour (18 * 1.75 = 31.5 → 32)
    ...
    watermelon = {
        ...
        seedCost = 130, basePrice = 130, growthTime = 140, waterNeeded = 5, harvestCooldown = 45, maxHarvestCycles = 1,
        productionRate = 101, -- crops per hour (38 * 1.75 = 66.5 → 67)
    ...
    zucchini = {
        ...
        seedCost = 38, basePrice = 38, growthTime = 48, waterNeeded = 3, harvestCooldown = 18, maxHarvestCycles = 4,
        productionRate = 66, -- crops per hour (25 * 1.75 = 43.75 → 44)
