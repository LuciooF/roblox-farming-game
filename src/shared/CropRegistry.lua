...
CropRegistry.crops = {
    ...
    wheat = {
        ...
        productionRate = 8, -- crops per hour
    ...
    carrot = {
        ...
        productionRate = 10, -- crops per hour
    ...
    basil = {
        ...
        productionRate = 12, -- crops per hour
    ...
    potato = {
        ...
        productionRate = 15, -- crops per hour
    ...
    onion = {
        ...
        productionRate = 14, -- crops per hour
        waterCooldown = 20, maintenanceWaterInterval = 10800, -- 20s between waters, 3h maintenance
    ...
    lettuce = {
        ...
        productionRate = 16, -- crops per hour
    ...
    tomato = {
        ...
        productionRate = 18, -- crops per hour
    ...
    strawberry = {
        ...
        productionRate = 20, -- crops per hour
        waterCooldown = 25, maintenanceWaterInterval = 12600, -- 25s between waters, 3.5h maintenance
    ...
    corn = {
        ...
        productionRate = 22, -- crops per hour
    ...
    broccoli = {
        ...
        productionRate = 24, -- crops per hour
    ...
    eggplant = {
        ...
        productionRate = 25, -- crops per hour
    ...
    bell_pepper = {
        ...
        productionRate = 23, -- crops per hour
    ...
    avocado = {
        ...
        productionRate = 28, -- crops per hour
    ...
    mango = {
        ...
        productionRate = 27, -- crops per hour
    ...
    acorn = {
        ...
        productionRate = 11, -- crops per hour
    ...
    banana = {
        ...
        productionRate = 13, -- crops per hour
    ...
    blueberry = {
        ...
        productionRate = 21, -- crops per hour
    ...
    cherry = {
        ...
        productionRate = 26, -- crops per hour
    ...
    coconut = {
        ...
        productionRate = 29, -- crops per hour
    ...
    dragonfruit = {
        ...
        productionRate = 35, -- crops per hour
    ...
    cucumber = {
        ...
        productionRate = 17, -- crops per hour
